      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', err.reponse.data.message);
...
var stripe = Stripe('pk_test_51I4o1gDBYCX4zdTPvw6Wznl6x90IQf68QFpvyRGWCluPeODpLiFBktowHQuPUtEmDiT0ENbdamLS3seMQJVDV6Cv00YaGrNFB3');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2: Create checkout four + charge credit card
